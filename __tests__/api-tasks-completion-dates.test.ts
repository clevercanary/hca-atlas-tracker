...
const ATLAS_NAMES_PUBLISHED_WITH_HCA = [
  `${ATLAS_WITH_IL.shortName} v${ATLAS_WITH_IL.generation}.${ATLAS_WITH_IL.revision}`,
  `${ATLAS_WITH_SOURCE_STUDY_VALIDATIONS_A.shortName} v${ATLAS_WITH_SOURCE_STUDY_VALIDATIONS_A.generation}.${ATLAS_WITH_SOURCE_STUDY_VALIDATIONS_A.revision}`,
];

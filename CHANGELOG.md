...
* report a 201 with an unparseable body as a failure, not a silent success ([#1550](https://github.com/clevercanary/hca-atlas-tracker/issues/1550)) ([#1580](https://github.com/clevercanary/hca-atlas-tracker/issues/1580)) ([a85a1b6](https://github.com/clevercanary/hca-atlas-tracker/commit/a85a1b697d8c25ab134cb6df670c3fc804b89a16))
...
* make pending-until-refetch declarative so a forgotten return can't race ([#1553](https://github.com/clevercanary/hca-atlas-tracker/issues/1553)) ([#1579](https://github.com/clevercanary/hca-atlas-tracker/issues/1579)) ([aabb559](https://github.com/clevercanary/hca-atlas-tracker/commit/aabb559225ba8b5d85f9f0374afa81c5a266ca28))
* stack error snackbars so a second error can't hide an unread first one ([#1569](https://github.com/clevercanary/hca-atlas-tracker/issues/1569)) ([#1572](https://github.com/clevercanary/hca-atlas-tracker/issues/1572)) ([0c80583](https://github.com/clevercanary/hca-atlas-tracker/commit/0c805831eb88b23cc53ea867c489768ad279a73a))


### Performance Improvements

* stop the archive button awaiting the atlas refetch it doesn't depend on ([#1554](https://github.com/clevercanary/hca-atlas-tracker/issues/1554)) ([#1577](https://github.com/clevercanary/hca-atlas-tracker/issues/1577)) ([f7d72ce](https://github.com/clevercanary/hca-atlas-tracker/commit/f7d72ceb60ff3a3460f0f6a545c6d6aaf379af9f))


### Tests

* pin the landing header's kept and dropped fields ([#1556](https://github.com/clevercanary/hca-atlas-tracker/issues/1556)) ([#1574](https://github.com/clevercanary/hca-atlas-tracker/issues/1574)) ([7edd095](https://github.com/clevercanary/hca-atlas-tracker/commit/7edd09522fce4df5fbdc3b097fcf8e158d4a6ca5))
...
* call hca validator 'hca' instead of hca schema in the list and detail tab ([#947](https://github.com/clevercanary/hca-atlas-tracker/issues/947)) ([#948](https://github.com/clevercanary/hca-atlas-tracker/issues/948)) ([3a9fb52](https://github.com/clevercanary/hca-atlas-tracker/commit/3a9fb525b8f875be96bdc1dcb1d05e93d86d8ac2))
* save and display hca schema validator results from dataset validator ([#944](https://github.com/clevercanary/hca-atlas-tracker/issues/944), [#945](https://github.com/clevercanary/hca-atlas-tracker/issues/945)) ([#946](https://github.com/clevercanary/hca-atlas-tracker/issues/946)) ([1375d5d](https://github.com/clevercanary/hca-atlas-tracker/commit/1375d5dc45fef4debe6040d276994c4eb6d4f6e4))
* save and display hca schema validator results from dataset validator ([#944](https://github.com/clevercanary/hca-atlas-tracker/issues/944)) ([1375d5d](https://github.com/clevercanary/hca-atlas-tracker/commit/1375d5dc45fef4debe6040d276994c4eb6d4f6e4))

...
import { ViewSourceStudies } from "../../components/Detail/components/ViewSourceDatasets/viewSourceDatasets";
...
export const SourceStudiesView = ({
  ...
  const { sourceDatasets: sourceStudies } = useFetchSourceDatasets(atlasId);

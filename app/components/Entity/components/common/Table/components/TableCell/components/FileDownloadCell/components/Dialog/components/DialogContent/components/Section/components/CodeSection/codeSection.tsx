import { Section } from "@/app/components/Entity/components/common/Table/components/TableCell/components/FileDownloadCell/components/Dialog/components/DialogContent/components/Section/section";

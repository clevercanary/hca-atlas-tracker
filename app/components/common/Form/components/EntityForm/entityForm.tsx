...
interface EntityFormProps<T extends FieldValues, R = undefined> {
  accessFallback: ReactNode;
  formManager: FormManagerProps;
  formMethod: FormMethod<T, R>;
  sectionConfigs: SectionConfig<T, R>[];
}

export const EntityForm = <T extends FieldValues, R = undefined>({
  accessFallback,
  formManager,
  formMethod,
  sectionConfigs,
}: EntityFormProps<T, R>): JSX.Element => {

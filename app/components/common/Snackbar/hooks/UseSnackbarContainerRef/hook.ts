 ...
 * viewport corner.
 *
 * Keyed on `open` rather than on the Paper unmounting, even though the ref
 * callback alone would be simpler. MUI keeps the Paper mounted through the
...
export const useSnackbarContainerRef = (
  ...
  }, [claimContainer, node, open, releaseContainer]);

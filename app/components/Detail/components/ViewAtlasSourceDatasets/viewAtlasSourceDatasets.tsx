      ...
      <GridPaper>
        {atlas && atlasSourceDatasets.length > 0 && (
          <Table
            ...
            gridTemplateColumns="max-content minmax(100px, auto) minmax(180px, 0.4fr) minmax(88px, 0.4fr) minmax(180px, 0.4fr) minmax(200px, 1fr) repeat(4, minmax(88px, 0.4fr)) auto"

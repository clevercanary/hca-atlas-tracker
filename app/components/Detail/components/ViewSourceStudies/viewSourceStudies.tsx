        ...
        <GridPaper>
          ...
          {sourceStudies.length > 0 && (
            <Table
              ...
              gridTemplateColumns="max-content minmax(260px, 1.2fr) minmax(100px, 0.5fr) minmax(80px, 1.2fr) minmax(80px, 0.75fr) minmax(170px, 0.75fr) minmax(130px, 0.75fr) minmax(170px, 0.75fr)"

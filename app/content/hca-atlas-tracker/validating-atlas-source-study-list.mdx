...
<Figure
  src="/docs/validating-source-studies/atlas-list.png"
  alt="The Atlases list page, showing each atlas with its source studies count"
/>
...
<Figure
  src="/docs/validating-source-studies/atlas-overview.png"
  alt="An atlas overview page"
/>

2. To view the atlas’s source studies, select the “Source Studies” tab.

<Figure
  src="/docs/validating-source-studies/source-studies-tab.png"
  alt="An atlas's Source Studies tab, listing its source studies"
/>
...
<Figure
  src="/docs/validating-source-studies/add-source-study-button.png"
  alt="The Add Source Study button at the top right of the source studies list"
/>
...
<Figure
  src="/docs/validating-source-studies/add-source-study-form-published.png"
  alt="The Add Source Study form with the published (DOI) tab selected"
/>
...
<Figure
  src="/docs/validating-source-studies/add-source-study-form-unpublished.png"
  alt="The Add Source Study form with the unpublished (no DOI) tab selected"
/>
...
<Figure
  src="/docs/validating-source-studies/edit-source-study-form-unpublished.png"
  alt="The edit form for an unpublished source study"
/>
...
<Figure
  src="/docs/validating-source-studies/delete-source-study-button.png"
  alt="The Delete button in the source study detail page's actions menu"
/>

 ...
 * page-scoped lookups. Strips query string, fragment, and trailing slashes
 * so visually-equivalent paths compare equal regardless of format quirks
 * on either side (backend emission vs `router.asPath`).

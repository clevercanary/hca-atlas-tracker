import { dbSourceDatasetToApiFileSourceDataset } from "app/apis/catalog/hca-atlas-tracker/common/backend-utils";
...
export default handler(
  ...
  async (req, res) => {
    ...
    res
      .status(200)
      .json(
        (await getAtlasDatasets(atlasId)).map(
          dbSourceDatasetToApiFileSourceDataset
        )
      );
  }
);
